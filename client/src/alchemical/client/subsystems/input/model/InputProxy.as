 ...
 */
package alchemical.client.subsystems.input.model 
{
	...
	public class InputProxy extends Proxy 
	{
		...
		public function registerControlBinding(actionName:String, primary:String, secondary:String):void 
		{
			...
			Debugger.log(this, "Control registered: " + actionName + " (" + actionCode+") -> " + primary + " (" + getAsciiCode(primary) + ") " + secondary + " (" + getAsciiCode(secondary) + ")");
		}
		...
		{
			Debugger.log(this, "Action registered: " + name+" -> " + code);
		...
		{
			Debugger.log(this, "Ascii code registered: " + key + " -> " + ascii);
