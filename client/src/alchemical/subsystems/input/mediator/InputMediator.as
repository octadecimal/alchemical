 ...
 */
package alchemical.subsystems.input.mediator 
{
	...
	import alchemical.subsystems.input.model.vo.MouseVO;
	...
	public class InputMediator extends Mediator 
	{
		...
		private function onKeyDown(e:KeyboardEvent):void 
		{
			...
			if (!_proxy.isKeyDown(e.keyCode))
			{
				...
				// Send action
				sendNotification(InputNotifications.KEY_DOWN, _proxy.getActionCodeByAscii(e.keyCode), _proxy.focus);
			}
		}
		...
		private function onKeyUp(e:KeyboardEvent):void 
		{
			...
			if (_proxy.isKeyDown(e.keyCode))
			{
				...
				// Send action
				sendNotification(InputNotifications.KEY_UP, _proxy.getActionCodeByAscii(e.keyCode), _proxy.focus);
			}
		}
		...
		{
			sendNotification(InputNotifications.RIGHT_CLICK, new MouseVO(e.stageX, e.stageY));
		}
		
		private function onMouseWheel(e:MouseEvent):void 
		{
			sendNotification(InputNotifications.MOUSE_WHEEL, new MouseVO(e.stageX, e.stageY, e.delta));
		}
